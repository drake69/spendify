...
WINGET_DIR="${BUILD_DIR}/winget/manifests/d/SpendifAi/SpendifAi/${NEW_VERSION}"

if ! $DRY_RUN; then
  mkdir -p "${WINGET_DIR}"

  # Version manifest
  cat > "${WINGET_DIR}/SpendifAi.SpendifAi.yaml" << WINGET_VERSION
# winget version manifest — SpendifAi.SpendifAi
...
PackageIdentifier: SpendifAi.SpendifAi
...
WINGET_VERSION
  ...
  cat > "${WINGET_DIR}/SpendifAi.SpendifAi.installer.yaml" << WINGET_INSTALLER
# winget installer manifest — SpendifAi.SpendifAi
# Generated by packaging/release.sh. Submit as PR to microsoft/winget-pkgs.
...
WINGET_INSTALLER
  ...
  # Locale manifest
  cat > "${WINGET_DIR}/SpendifAi.SpendifAi.locale.en-US.yaml" << WINGET_LOCALE
# winget locale manifest — SpendifAi.SpendifAi
# Generated by packaging/release.sh. Submit as PR to microsoft/winget-pkgs.
...
info "  2. Copy ${WINGET_DIR}/ to manifests/d/SpendifAi/SpendifAi/${NEW_VERSION}/ in your fork"
info "  3. Open a pull request — the winget-bot will validate automatically"
info "  4. Once merged, users can: winget install SpendifAi.SpendifAi"
