...
#
# Usage:
#   .\tests\run_benchmark_full.ps1
#   .\tests\run_benchmark_full.ps1 -Runs 3
#   .\tests\run_benchmark_full.ps1 -Benchmark pipeline
#   .\tests\run_benchmark_full.ps1 -Benchmark categorizer
#   .\tests\run_benchmark_full.ps1 -VllmUrl http://gpu:8000/v1
#   .\tests\run_benchmark_full.ps1 -OllamaUrl http://192.168.1.5:11434
#   .\tests\run_benchmark_full.ps1 -SkipLlama
#   .\tests\run_benchmark_full.ps1 -SkipOllama
#   .\tests\run_benchmark_full.ps1 -SkipVllm
#   .\tests\run_benchmark_full.ps1 -SetupOnly
...
function Invoke-Phase {
    ...
    $script = if ($Phase -eq "pipeline") { "tests/benchmark_pipeline.py" } else { "tests/benchmark_categorizer.py" }
    $script:Step++
    Write-Host ""
    Write-Host "────────────────────────────────────────────────────────────"
...
if ($IsUNC) {
    $localRes  = Join-Path $WorkDir "tests\generated_files\benchmark"
    $remoteRes = Join-Path $SourceDir "tests\generated_files\benchmark"
    Write-Host ""
