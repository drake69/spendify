...
|---|---|---|
| `gemma-2-2b-it-Q4_K_M` | ~1.6 GB | Google Gemma 2B — lightweight, good for categorisation |
| `phi-3-mini-4k-instruct-Q4_K_M` | ~2.3 GB | Microsoft Phi-3 Mini — balanced quality/speed |
