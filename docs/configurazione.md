...
## 1. Prima configurazione obbligatoria

**⚠️ Prima di effettuare qualsiasi importazione devi completare questi due passi:**

| Ordine | Cosa configurare | Dove | Perché è obbligatorio |
|---|---|---|---|
| 1 | **Nomi titolari** | Impostazioni → Titolari | Necessari per il rilevamento giroconti e la sanitizzazione PII |
| 2 | **Almeno un conto bancario** | Impostazioni → Conti bancari | Raccomandato per deduplicazione stabile tra sessioni |

Se i nomi titolari non sono configurati, la pagina Import mostra un errore e blocca l'elaborazione.
...
[ ] 2. Compila "Nomi titolari" con il tuo nome (e varianti)
[ ] 3. Aggiungi i tuoi conti bancari (almeno i principali)
[ ] 4. Scegli il backend LLM e configura URL/API key se necessario
[ ] 5. Clicca "💾 Salva impostazioni"
[ ] 6. Torna in 📥 Import e carica il primo estratto conto
```
